...
object Colors {
    object ThemeColorScheme {
        ...
        private val blueDarkColorScheme = darkColorScheme(
            ...
            errorContainer = Color(0xFFFFCDD2), // 错误色的容器背景
            onErrorContainer = Color(0xFFB71C1C), // 错误色容器上的文字颜色
            background = darkColorScheme().background, // 背景色
            onBackground = darkColorScheme().onBackground, // 背景上的文字颜色
            surface = darkColorScheme().surface, // 表面色
            onSurface = darkColorScheme().onSurface, // 表面色上的文字颜色
            inverseSurface = darkColorScheme().inverseSurface, // 反转表面色
            inverseOnSurface = darkColorScheme().inverseOnSurface, // 反转表面色上的文字颜色
            inversePrimary = darkColorScheme().background // 反转主色
        )
